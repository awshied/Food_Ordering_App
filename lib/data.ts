const dummyData = {
  categories: [
    { name: "Burger", description: "Burger lezat dengan daging panggang" },
    { name: "Pizza", description: "Pizza hangat dengan lelehan keju" },
    {
      name: "Kebab",
      description: "Kebab isi daging dan sayuran yang menggoda",
    },
    {
      name: "Roti Bakar",
      description: "Roti bakar isi selai atau daging spesial",
    },
    {
      name: "Minuman",
      description: "Aneka minuman dingin dan hangat untuk melengkapi hidangan",
    },
    { name: "Dessert", description: "Hidangan penutup yang manis dan lembut" },
  ],

  customizations: [
    // Breads
    { name: "Brioche", price: 0, type: "bread" },
    { name: "Gandum", price: 0, type: "bread" },
    { name: "Tortilla", price: 0, type: "bread" },
    { name: "Tawar Putih", price: 0, type: "bread" },
    { name: "Sesame", price: 0, type: "bread" },

    // Sizes
    { name: "Small", price: 0, type: "size" },
    { name: "Medium", price: 4, type: "size" },
    { name: "Large", price: 8, type: "size" },
    { name: "Extra Large", price: 12, type: "size" },

    // Sides
    { name: "Sup", price: 7.5, type: "side" },
    { name: "Pete", price: 5, type: "side" },
    { name: "Nasi", price: 2, type: "side" },
    { name: "Udang Keju", price: 7, type: "side" },
    { name: "Kentang Goreng", price: 5.5, type: "side" },

    // Crusts
    { name: "Keju", price: 15, type: "crust" },
    { name: "Tebal", price: 0, type: "crust" },
    { name: "Tipis", price: 0, type: "crust" },

    // Meats
    { name: "Sapi", price: 4, type: "meat" },
    { name: "Ayam", price: 4, type: "meat" },
    { name: "Kambing", price: 4, type: "meat" },
    { name: "Babi", price: 4.5, type: "meat" },
    { name: "Sosis", price: 3, type: "meat" },

    // Cheeses
    { name: "Mozzarela", price: 6.5, type: "cheese" },
    { name: "Cheddar", price: 4, type: "cheese" },
    { name: "Parmesan", price: 4, type: "cheese" },

    // Vegetables
    { name: "Selada", price: 1.5, type: "vegetable" },
    { name: "Tomat", price: 1.5, type: "vegetable" },
    { name: "Bawang", price: 1.5, type: "vegetable" },
    { name: "Paprika", price: 1.5, type: "vegetable" },
    { name: "Cabai", price: 1.5, type: "vegetable" },

    // Sauces
    { name: "Tomat", price: 0.5, type: "sauce" },
    { name: "Sambal", price: 0.5, type: "sauce" },
    { name: "Mayones", price: 2, type: "sauce" },
    { name: "BBQ", price: 3.5, type: "sauce" },

    // Spices
    { name: "Tidak Pedas", price: 0, type: "spice" },
    { name: "Sedang", price: 0, type: "spice" },
    { name: "Pedas", price: 0, type: "spice" },
    { name: "Pedas Banget", price: 2.5, type: "spice" },
    { name: "Nyari Mati", price: 4.5, type: "spice" },

    // Temperatures
    { name: "Hot", price: 0, type: "temperature" },
    { name: "Biasa", price: 0, type: "temperature" },
    { name: "Cold", price: 0, type: "temperature" },
  ],
